...
// End Import Creates
	...
	return (ProductInfoExt) new PreparedSentence(s
		, "SELECT "
                ...
                + "SUPPLIER, "
                + "UOM, "
                + "CONCAT(\"'\", DATE_FORMAT(STR_TO_DATE(DATEDUE, '%Y-%m-%d'), '%Y%m%d'), \"'\") AS DATEDUE "
...
//  last digit (position 7) can be used to identify COUPON (5 or 9) - FUTURE              
	...
	return new PreparedSentence(s
		, "SELECT "
                ...
                + "P.SUPPLIER, "        
                + "P.UOM, "
                + "CONCAT(\"'\", DATE_FORMAT(STR_TO_DATE(P.DATEDUE, '%Y-%m-%d'), '%Y%m%d'), \"'\") AS DATEDUE "
    ...
    public List<ProductInfoExt> getProductConstant() throws BasicException {
		...
		, "SELECT "
                    ...
                    + "products.SUPPLIER, "
                    + "products.UOM, "
                    + "CONCAT(\"'\", DATE_FORMAT(STR_TO_DATE(products.DATEDUE, '%Y-%m-%d'), '%Y%m%d'), \"'\") AS DATEDUE "
...
// JG 3 feb 16 speedup  + "P.IMAGE, "
                    ...
                    + "P.UOM, "                    
                        ...
                        + " END, "
                    + "C.CATORDER, "
                    + "STR_TO_DATE( P.DATEDUE, '%Y-%m-%d' ) AS DATEDUE "
