...
# start uniCenta oPOS
java -cp $CP -Xms512m -Xmx1024m -splash:unicenta_splash_dark.png -Djava.library.path=$DIRNAME$LIBRARYPATH -Ddirname.path=$DIRNAME/ com.unicenta.pos.transfer.TransferPanel “$@“